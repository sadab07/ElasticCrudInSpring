...
public class ElasticController
{
	...
	@GetMapping("/view-student-by-id/{index}/{id}/{field}/{fieldValue}")
	public ResponseEntity<?> getStudentById(@PathVariable String id,@PathVariable String index,@PathVariable String field,@PathVariable String fieldValue,HttpSession httpSession)
	{
		elasticService.getStudentById(index,id,field,fieldValue,httpSession);
		Map<String, Object> map = new HashMap<String, Object>();
